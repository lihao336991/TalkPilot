...
- 项目工程操作（EAS 构建/更新、法务页面发布、Edge Function 部署、密钥同步等）统一参考 `.trae/rules/project-ops.md`
- 任何涉及 `eas build`、`eas update`、`legal:build`、`legal:publish`、`supabase functions deploy`、`sync-secrets` 的操作，都应先阅读该文件确认参数与流程
