export const en = {
  ...
  live: {
    ...
    startSession: {
      ...
      cancelAccessibilityLabel: "Cancel starting conversation",
      titleReady: "Start Conversation",
      subtitleReady: "Tap to begin your live session",
      titlePreparing: "Getting things ready",
      subtitlePreparing: "Checking mic access and preparing the audio session",
      titleConnecting: "Connecting your live session",
      subtitleConnecting: "Opening the speech stream so you can start talking right away",
      titleFinalizing: "Almost there",
      subtitleFinalizing: "Creating your session and switching the mic live",
      connectingPreparing: "Preparing",
      connectingOpening: "Connecting",
      connectingFinalizing: "Finalizing",
      ...
      usageConnectingHint: "You can cancel anytime before the session goes live",
    },
    voiceEnrollment: {
      title: "Voice Setup",
      introBody:
